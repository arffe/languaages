# skier game
# from Hello World python book, so Copyright Warren Sande, 2009
...
class ObstacleClass(pygame.sprite.Sprite):
 ...
 # creates window of random trees and flags
...
#  redraws sceeen when things move
def animate(): 
...
# change to next screen or scenery
...
# start main loop
while True:
    # update graphics 30 times a second
    clock.tick(30)
